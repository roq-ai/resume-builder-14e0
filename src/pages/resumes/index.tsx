...
export function ResumeListPage(props: ResumeListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getResumes({
        relations: ['user', 'template', 'education.count', 'experience.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('template', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('education', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'education',
          header: 'Education',
          accessorKey: 'education',
          cell: ({ row: { original: record } }: any) => record?._count?.education,
        }
      : null,
