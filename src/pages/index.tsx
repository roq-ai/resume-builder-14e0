  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower Your Career with Resume Builder - Your Ultimate Tool for Crafting Impactful Resumes Across Various Templates"
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1565688534245-05d6b5be184a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZXN1bWV8ZW58MHx8fHwxNjkyNjk4NjA1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower Your Career with Resume Builder - Your Ultimate Tool for Crafting Impactful Resumes Across Various Templates`}
            </Text>
            <Box
